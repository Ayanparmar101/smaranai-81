            ...
            <nav className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-auto py-6 px-4">
                <div className="space-y-6">
                  ...
                  {user && <button onClick={handleNavigation("/teacher")} className="flex items-center gap-2 p-3 hover:bg-[#1d1d1d] transition-colors rounded-lg w-full text-left px-[19px] py-0 my-0 mx-0">
